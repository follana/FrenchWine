...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230106_sandy_follana_frenchwine_10d3089126eef6c79644_20230106112822_archive.zip';
        const ARCHIVE_SIZE       = '82572801';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '10d3089-06112822';
        const SECONDARY_PACKAGE_HASH = 'af2ccd2-06112822';
        const VERSION            = '1.5.1';
